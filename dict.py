...
import pymysql
a=1
f=open('/home/ubuntu/PycharmProjects/PythonProject/PythonProject/数据库基础/mysql/dict.txt','r')
db=pymysql.connect(host='localhost',port=3306,user='root',password='123',database='dict',charset='utf8')
cur=db.cursor()
#自己的
...
#     db.commit()
#老师的
sql="insert into word (word,interpret) values (%s,%s)"
for line in f:
    ######################
    # tmp=line.split(' ')
    # word=tmp[0]
